...
function Banner() {
	...
	const imgSrc = screenOrientation === 'landscape' ? 'banner/employers.png' : 'banner/employee.png';
		...
		<section className='banner' id='banner'>
			<div className='banner__wrapper wrapper'>
				...
				<div className='banner__image image'>
					<img className='employers' src={imgSrc} alt='employers' style={employeeStyle}></img>
				</div>
